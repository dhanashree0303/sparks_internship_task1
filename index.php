...
<html lang="en">
  ...
  include 'navbar.php';
  ?>
      <img src="img/pexe.jpg" alt="Bank" style="width: 100%; height: 80%; position: absolute; z-index: -1; opacity: 0.8; " >
      ...
      <footer class="text-center mt-5 py-2" style = "background-color: #0000";>
        <p style = "color: white";> <strong>&copy 2021. Made by <b> Dhanashree Shripatwar </b><br>  State Bank of India <br></strong></p>
      </footer>
